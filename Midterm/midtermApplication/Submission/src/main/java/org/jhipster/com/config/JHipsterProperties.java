...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "midtermApplication@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "midtermApplication API";

        private String description = "midtermApplication API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "midtermApplication";

(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('midtermApplicationApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-midtermApplicationApp-error');
                var entityKey = httpResponse.headers('X-midtermApplicationApp-params');
                if (errorHeader) {
